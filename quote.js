...
const Quote = (props) => {
  return (
    <div className="quote-container">
      <Helmet>
        <title>Quote - Sparktopus Data Recovery: Rescuing Your Precious Data</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Quote - Sparktopus Data Recovery: Rescuing Your Precious Data"
        />
        <meta
        ...
        <div data-thq="thq-mobile-menu" className="quote-mobile-menu">
          ...
          >
            <div className="quote-container01">
              <span className="quote-logo">Sparktopus Recovery</span>
