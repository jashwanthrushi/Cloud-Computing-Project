...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Sparktopus</title>
        <meta
          name="description"
          content='"Sparktopus Data Recovery specializes in retrieving lost, damaged, or inaccessible data from various storage devices."'
        />
        <meta
          property="og:title"
          content="Sparktopus Data Recovery"
        />
        <meta
        ...
        <div data-thq="thq-mobile-menu" className="home-mobile-menu">
          ...
          >
            <div className="home-container1">
              <span className="home-logo">Sparktopus</span>
        ...
        <div className="home-container2">
          <div className="home-heading">
            <h1 className="home-header">
              ...
              <span className="home-text12">from </span>
              ...
              <span className="home-text14">Disaster</span>
              ...
              <span className="home-text16">Site.</span>
            </h1>
            ...
            <div className="home-main">
              <div className="home-content1">
                ...
                <p className="home-description2">
                  <span>
                    Losing precious photos can be heart-wrenching, but Sparktopus 
              ...
              <div className="home-content2">
                ...
                <p className="home-description3">
                  <span className="home-text24">
                    Important documents lost? Don&apos;t worry – Sparktopus  Data
            ...
            <div className="home-main2">
              <div className="home-content3">
                ...
                <p className="home-description4">
                  Lost a crucial file? Trust Sparktopus  Data Recovery to retrieve it.
            ...
            <div className="home-main3">
              <div className="home-content4">
                <h2 className="home-header4">
                  <span className="home-text28">Video  Restoration</span>
                  <br></br>
                </h2>
                <p className="home-description5">
                  <span className="home-text30">
                    Did a special video disappear unexpectedly? Sparktopus  Data
            ...
            <div className="home-main4">
              <div className="home-content5">
                ...
                <p className="home-description6">
                  ...
                  your valuable data. With a commitment to excellence, Sparktopus 
          ...
          <div className="home-content6">
            <div className="home-heading1">
              ...
              <p className="home-header7">
                No matter the storage device, Sparktopus  Data Recovery is dedicated
            ...
            <div className="home-heading2">
              ...
              <p className="home-caption">
                <span className="home-text37">
                  The duration of Sparktopus&apos;s data recovery process can vary
                ...
                <span className="home-text40">
                  ...
                  Sparktopus&apos;s priority is to ensure a thorough and accurate
                  recovery process rather than rushing through it.
                </span>
                <br className="home-text41"></br>
                <br className="home-text42"></br>
                <span className="home-text43">
                  When you contact Sparktopus Data Recovery, our experts will provide
