...
const AboutUs = (props) => {
  return (
    <div className="about-us-container">
      <Helmet>
        <title>
          Sparktopus : Data Recovery made Easy
        </title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="About-Us - Sparktopus Data Recovery: Rescuing Your Precious Data"
        />
        <meta
        ...
        <div className="about-us-container2">
          <div className="about-us-heading">
            <h1 className="about-us-header">
              ...
              <span className="about-us-text09">Sparktopus  Data Recovery</span>
            ...
            <span className="about-us-text12">
              <span className="about-us-text13">
                At Sparktopus  Data Recovery, we understand that data loss can be a
              ...
              <span className="about-us-text31">
                At Sparktopus  Data Recovery, we&apos;re not just experts in
